...
class QueryDBTestCase(unittest.TestCase):
    ...
    def add_data(self):
        self.cur.execute(
            'INSERT INTO band (name, region) VALUES ("Black Dyke", "Yorkshire")'
        )
        self.cur.execute(
            """INSERT INTO result (position, band_id, conductor, draw, year)
    ...
    def test_add_result_new_band(self):
        ...
        self.assertEqual(
            [(1, "Black Dyke", "Yorkshire"), (2, "Foden's", "North West")],
